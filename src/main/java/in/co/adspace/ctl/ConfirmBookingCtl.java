...
/**
 * Servlet implementation class ConfirmBookingCtl
 */
public class ConfirmBookingCtl extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ConfirmBookingCtl() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		 long bookingId = Long.parseLong(request.getParameter("bookingid"));
	        ...
	        boolean success = bookingModel.updateBookingStatus(bookingId, "Confirmed");

	        if (success) {
	            // Update successful, redirect back to ViewAllBooking.jsp
	           request.setAttribute("confirm","request confirm");
	           List<BookingBean> list = bookingModel.listbook();
	            ...
	            // Handle failure, maybe display an error message
		           request.setAttribute("noncon","request not confirm");
	        }
