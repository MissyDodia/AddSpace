...
<section class=" " >
  <div class="  container flex flex-col items-center justify-center px-4 py-8 mx-auto md:h-screen lg:py-4" style="width: 40%">
      ...
      <div class="w-full  rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              <h1 class="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">
                  ...
                  %>
                  <font style="color: red"><%= (error!=null)?error:""%></font><br>
                  Sign in to your account
                 
              </h1>
              <form class="space-y-4 md:space-y-6" action="LoginCtl" method="post">
                  <div>
  ...
  <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Sign In</button>
                  <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                      Don’t have an account yet? <a href="SignUpCtl" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Sign up</a>
                  </p>
              </form>
          </div>
      </div>
