            ...
            <% for (BookingBean booking : list) { %>
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="flex items-center px-6 py-4">
                       <a href="CancelBookingCtl?bookingid=<%=booking.getId() %>" class="font-medium text-red-600 dark:text-red-500 hover:">Cancel</a>
    <a href="ConfirmBookingCtl?bookingid=<%=booking.getId() %>" class="font-medium text-green-600 dark:text-green-500 ms-3">Confirm</a>
   			
                        <a href="DeleteBookingCtl?bookingid=<%=booking.getId() %>" class="font-medium text-red-600 dark:text-red-500 ms-3">Delete</a>
                    </td>
                </tr>
            <% } %>
        <% } else { %>
